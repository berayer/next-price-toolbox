...
INSERT INTO "new_MatColorPriceType" ("createdAt", "expression", "id", "name", "priceModel", "priority", "remark", "unit", "updatedAt") SELECT "createdAt", "expression", "id", "name", "priceModel", "priority", "remark", "unit", "updatedAt" FROM "MatColorPriceType";
